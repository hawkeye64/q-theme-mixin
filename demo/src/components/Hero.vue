<template>
  <div>
    <section class="page-header">
      <div class="text-h1 project-name">QThemeMixin</div>
      <div class="text-h2 project-tagline">Mixin library for Vue Render Functions</div>
      ...
      <div class="quasar">A Quasar Framework Mix-in</div>
      ...
      <q-btn type="a" href="https://github.com/hawkeye64/q-theme-mixin" target="_blank" class="btn" label="View on GitHub" no-caps flat/>
